def add_to_dict(dictionary=None, word=None, definition=None):
  ...
  elif definition is None or word is None: 
...
def get_from_dict(dictionary=None, word=None):
  if type(dictionary) is not dict : 
    print(f"You need to send a dictionary. You send : {type(dictionary)}")
  elif word is None :
...
def update_word(dictionary=None, word=None, definition=None):
  if type(dictionary) is not dict : 
    print(f"You need to send a dictionary. You send : {type(dictionary)}")
  elif definition is None or word is None: 
...
def delete_from_dict(dictionary=None, word=None):
  if type(dictionary) is not dict : 
    print(f"You need to send a dictionary. You send : {type(dictionary)}")
  elif word is None:
